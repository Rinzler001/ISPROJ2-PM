<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blank-page.aspx.cs" Inherits="ISPROJ2_PrototypeMk2.blank_page" %>
                            ...
                            <div>
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtStDate" runat="server" Width="150px" ReadOnly="False" Placeholder="Choose Date" TextMode="Date"></asp:TextBox>
                                            <%--<ajaxToolkit:CalendarExtender ID="txtStDate_CalendarExtender" runat="server" TargetControlID="txtStDate" Format="yyyy-MM-dd" />--%>
                                            <br />
                                            <asp:TextBox ID="txtEnDate" runat="server" Width="150px" ReadOnly="False" Placeholder="Choose Date" TextMode="Date"></asp:TextBox>
