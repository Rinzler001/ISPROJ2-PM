<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboard.aspx.cs" Inherits="Default2" %>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="dashboard.aspx"><i class="fa fa-user-circle-o"></i>[NAME OF USER]</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Dashboard
                            <small>- Project Leader / Supervisor </small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Status of Projects</h3>
                            </div>
                            <div class="panel-body">
                                <div id="morris-area-chart"><img src="http://wiki.bdei.com/images/0/0d/OpenServiceNowProject.png" /></div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div id="morris-donut-chart"><img src="http://www.jqueryscript.net/images/Create-Pretty-Animated-Donut-Charts-with-jQuery-Chart-js.jpg" /></div>
